      ...
      <Modal>
        ...
        <div className={`${isImage ? "block" : "hidden"} md:w-[600px] w-[400px] md:h-[500px] h-[300px] rounded-lg pl-10 md:pt-16 pr-7 fixed z-50`}>
          ...
          <ModalFooter className="gap-4 items-center">
            ...
            <a href="https://www.flipkart.com/belidare-men-casual-evening-party-black-genuine-leather-belt/p/itm9d95af822a027?pid=BELH3YW2JFAHG9WC" target="_blank" className="md:px-2 flex items-center bg-gray-200 text-black dark:bg-black dark:border-black dark:text-white border border-gray-300 rounded-md text-sm w-28">
            <Image
                src="/flipkart-logo.png"
                alt="bali images"
                width="40"
            ...
            <a href="https://www.amazon.in/dp/B0DBM15B1R" target="_blank" className="md:px-2 flex items-center dark:bg-white dark:text-black dark:border-black border border-gray-300 rounded-md text-sm w-28">
            <Image
                src="/amazon-logo.png"
                alt="bali images"
                width="30"
