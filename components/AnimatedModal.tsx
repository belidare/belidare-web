  ...
  return (
    <div className="pt-6 flex">
      <Modal>
        ...
        <div className={`${isImage ? "block" : "hidden"} md:w-[600px] w-[400px] md:h-[500px] h-[300px] rounded-lg md:pl-20 pl-4 pr-20 md:pr-0 md:pb-10 fixed z-50`}>
          ...
          <ModalFooter className="gap-4 items-center">
            ...
            <a href="https://www.amazon.in/dp/B0DBM15B1R" target="_blank" className="md:px-2 flex items-center bg-white text-black border-black border rounded-md text-sm w-28">
            <Image
                src="/amazon-logo.png"
                alt="bali images"
                width="30"
