...
export function AnimatedModal1() {
  const images = [
    "/jsb0003/jsb0003-3.jpg",
    "/jsb0003/jsb0003-4.jpg",
    "/jsb0003/jsb0003-1.jpg",
    "/jsb0003/jsb0003-2.jpg",
    "/jsb0003/jsb0003-5.png"
  ];
  return (
      ...
      <Modal>
        ...
        <ModalBody>
          <ModalContent>
            ...
            Belidare Men&apos;s Reversible Genuine Leather Belt | Honey Comb Pattern
            </h4>
          ...
          <ModalFooter className="gap-4 items-center">
            <h5>Available On</h5>
            <a href="https://www.flipkart.com/belidare-men-casual-formal-black-brown-genuine-leather-reversible-belt/p/itma7c02ca654471?pid=BELH2YG3SKWC7QFF" target="_blank" className="px-2 flex items-center bg-gray-200 text-black dark:bg-black dark:border-black dark:text-white border border-gray-300 rounded-md text-sm w-28">
            <Image
                src="/flipkart-logo.png"
                alt="bali images"
                width="40"
            ...
            <a href="https://www.amazon.in/dp/B0DBM4L937" target="_blank" className="px-2 flex items-center dark:bg-white dark:text-black dark:border-black border border-gray-300 rounded-md text-sm w-28">
            <Image
                src="/amazon-logo.png"
                alt="bali images"
                width="30"
